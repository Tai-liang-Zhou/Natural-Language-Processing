...
def prepare_data(gen_config):
    ...
    # preparing the train files encoded as the vocabulary indexes
...
#                        print("3")
                    checkpoint_path = os.path.join(gen_ckpt_dir, "chitchat.ckpt")
